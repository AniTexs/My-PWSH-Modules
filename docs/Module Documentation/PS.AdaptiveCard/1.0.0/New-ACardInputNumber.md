...
```
New-ACardInputNumber [-Id] <String> [[-Label] <String>] [[-Placeholder] <String>] [[-Value] <Double>]
 [[-Min] <Double>] [[-Max] <Double>] [-IsRequired] [[-ErrorMessage] <String>] [[-Spacing] <Spacing>]
