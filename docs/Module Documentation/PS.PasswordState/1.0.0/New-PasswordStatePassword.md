---
external help file: PS.PasswordState-help.xml
Module Name: PS.PasswordState
online version:
schema: 2.0.0
---
...
```
New-PasswordStatePassword [-Title] <Object> [-Password] <SecureString> [-Username <String>] [-Domain <String>]
 [-HostName <String>] [-Description <String>] [-GenericField1 <String>] [-GenericField2 <String>]
 ...
 [-GenericFieldInfo <Hashtable>] [-Notes <String>] [-URL <String>] [-DenyExport]
...
### -GenericFieldInfo
{{ Fill GenericFieldInfo Description }}
